...
class Exp(BaseExp):
    ...
    def get_model(self):
        from SportsTracking.common.yolox.models import YOLOPAFPN, YOLOX, YOLOXHead
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from SportsTracking.common.yolox.utils import LRScheduler
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False):
        from SportsTracking.common.yolox.data import COCODataset, ValTransform
