...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument("-l", "--logger", type=str,
                             help="Logger to be used for metrics.", default="plain")
    self.parser.add_argument("--wandb_project", type=str,
                             help="Wanddb project name", default="tracking-algorithms-in-sports")
  ...
  def parse(self, args=''):
    ...
    opt.exp_dir = os.path.join(opt.root_dir, 'outputs')
